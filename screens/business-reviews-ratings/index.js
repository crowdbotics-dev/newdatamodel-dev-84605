...
import ImgBackUrl from "./assets/back.png"; // @ts-ignore

import ImgChessUrl from "./assets/chess.png"; // @ts-ignore

import ImgDownUrl from "./assets/down.png"; // @ts-ignore

import ImgGrayStarUrl from "./assets/gray-star.png"; // @ts-ignore

import ImgMiniStarUrl from "./assets/mini-star.png"; // @ts-ignore

import ImgNotiUrl from "./assets/noti.png"; // @ts-ignore

import ImgStarUrl from "./assets/star.png"; // @ts-ignore

import ImgTimerUrl from "./assets/timer.png"; // @ts-ignore
...
const BusinessReviewsRatingsScreen = () => {
  ...
  return <ScrollView style={styles.mainContainer}>
      <View style={styles.container}>
        ...
        <View style={[styles.textInput, styles.CgJonAvX]}>
          <Input placeholder='Enter' />
        </View>
        <Text style={styles.mr10}>User review</Text>
        <View style={[styles.textInput, styles.qkYCKqFs]}>
...
const Input = props => {
  return <View style={InputStyles.container}>
      <TextInput style={InputStyles.input} placeholder={props.placeholder} value={props.value} onChangeText={num => props.setValue(num)} placeholderTextColor='#000' multiline={props.multiline} numberOfLines={props.multiline ? 10 : null} editable={props.editable !== false} />
    </View>;
};
