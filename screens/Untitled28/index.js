...
const Untitled28 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      flex: 1
        ...
        height: 20,
        width: 20
      }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><ImageBackground style={styles.kOWXEdjW} source={{
      ...
      }} resizeMode="cover"></ImageBackground><RadioGroup style={styles.GFZHnxfo} radioButtons={[{
        id: "1",
        label: "Option 1",
        value: "option1"
      }, {
